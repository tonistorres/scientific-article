                    ...
                    {dbAuthors.length > 0 && dbAuthors.map((item, index) => {
                        return (
                            <tr key={item._id} scope="row">
                                <td className="td-mw-authors" >{item._source.authors.map(item => <ul className="ul-none"><li>{item}</li></ul>)}</td>
                                <td className="td-mw-type">{item._type}</td>
                                <td className="td-mw-title">{item._source.title}</td>
                                <td className="td-mw-descrip">{`${item._source.description}`.substring(0,50)+'...'}</td>
